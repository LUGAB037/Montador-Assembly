...
int main() {
    ...
    for (int i = 0; i < quant; i++)//percorre todas as linhasdo codigo assembly
    {
        ...
        if (operacao == "sll")
        {
            ...
            string rt = TraduzirBin("0");
            string shamt = TraduzirBin(reg3);
            string func = TraduzirBin(0);
            binariolinhas[i] = opcode + rs + rt + rd + shamt + func;

        }

        else if (operacao == "srl")
        {
            cont++;
            string reg1;
            carac = lines[i][cont];
            ...
            string opcode = TraduzirBin(0);
            string rd = TraduzirBin(reg1);
            string rs = TraduzirBin("0");
            string rt = TraduzirBin("0");
            string shamt = TraduzirBin(reg3);
            string func = TraduzirBin(2);
            binariolinhas[i] = opcode + rs + rt + rd + shamt + func;
        ...
        else if (operacao == "jr")
        {
            ...
            string opcode = TraduzirBin(0);
            string rd = TraduzirBin("0");
            string rs = TraduzirBin(reg2);
            string rt = TraduzirBin("0");
            string shamt = TraduzirBin("0");
            string func = TraduzirBin(8);
            binariolinhas[i] = opcode + rs + rt + rd + shamt + func;

        }
        else if (operacao == "mfhi")
        {
            ...
            string rt = TraduzirBin("0");
            string shamt = TraduzirBin("0");
            string func = TraduzirBin(16);
            binariolinhas[i] = opcode + rs + rt + rd + shamt + func;

        }

        else if (operacao == "mflo")
        {
        ...
        else if (operacao == "mult")
        {
            ...
            string shamt = TraduzirBin("0");
            string func = TraduzirBin(24);
            binariolinhas[i] = opcode + rs + rt + rd + shamt + func;

        }

        else if (operacao == "multu")
        {
            cont++;
            string reg2;
            carac = lines[i][cont];
        ...
        else if (operacao == "div")
        {
            ...
            string rt = TraduzirBin(reg3);
            string shamt = TraduzirBin("0");
            string func = TraduzirBin(26);
            binariolinhas[i] = opcode + rs + rt + rd + shamt + func;

        }
        else if (operacao == "divu")
        {
            cont++;
            string reg2;
            carac = lines[i][cont];
        ...
        else if (operacao == "add")
        {
            ...
            string reg3;
             ...
             reg1 = ConverterReg(reg1);
               reg2 = ConverterReg(reg2);
               reg3 = ConverterReg(reg3);
            string opcode = TraduzirBin(0);
            string rd = TraduzirBin(reg1);
            string rs = TraduzirBin(reg2);
            string rt = TraduzirBin(reg3);
         ...
         else if (operacao == "sub")
        {
            ...
            string rt = TraduzirBin(reg3);
            string shamt = TraduzirBin("0");
            string func = TraduzirBin(34);
            binariolinhas[i] = opcode + rs + rt + rd + shamt + func;

         }

         else if (operacao == "subu")
         {
             cont++;
             string reg1;
             carac = lines[i][cont];
         ...
         else if (operacao == "or")
         {
             ...
             string rt = TraduzirBin(reg3);
             string shamt = TraduzirBin("0");
             string func = TraduzirBin(37);
             binariolinhas[i] = opcode + rs + rt + rd + shamt + func;

         }

         else if (operacao == "slt")
         {
             cont++;
             string reg1;
             carac = lines[i][cont];
             ...
             string rt = TraduzirBin(reg3);
             string shamt = TraduzirBin("0");
             string func = TraduzirBin(42);
             binariolinhas[i] = opcode + rs + rt + rd + shamt + func;

         }

         else if (operacao == "sltu")
         {
             cont++;
             string reg1;
             carac = lines[i][cont];
